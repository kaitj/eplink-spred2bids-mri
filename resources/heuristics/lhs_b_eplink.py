...
def infotodict(seqinfo):
    ...
    dwi_RL = create_key('sub-{subject}/dwi/sub-{subject}_acq-multiband_dir-RL_dwi')
    dwi_LR = create_key('sub-{subject}/dwi/sub-{subject}_acq-multiband_dir-LR_dwi')
    dwi_singleband = create_key('sub-{subject}/dwi/sub-{subject}_acq-singleband_dir-RL_dwi')
